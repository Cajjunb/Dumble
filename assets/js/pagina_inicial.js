...
$(document).ready(function() {
	$(".redefinir_senha_link").css('display', 'none');
...
$(document).ready(function(){
				$(".button2,#arrow_button2").click(function(){
					...
					var esqueceu_senha = $(".redefinir_senha_link");
					...
					if(login_form.css('opacity')=='0'){
						...
						login_form.animate({
							...
							complete: function(){
								...
								esqueceu_senha.css('display', 'block');
							}
						});
					}else{
						...
						login_form.animate({
							...
							complete: function(){
								...
								esqueceu_senha.css('display', 'none');
							}
						});
					}
		});
  ...
  $("#cadastro").submit(function(e) {
		...
		$.ajax({		
	        ...
	        success : function(data, textStatus, jqXHR){
	        	...
	        	console.log(data);
	        	if(data == false)
	            	swal("Usuario Cadastrado com Sucesso!","Logue e veja os presentes que você pode ganhar","success");
	       		else{
	       			if( data == 'ERROR.DADOS')
